...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'createParamValueObject_$external_fun' : (p0, p1) => createParamValueObject(p0, p1),
        'gtag_$external_fun' : (p0, p1, p2, isDefault0) => gtag(p0, p1, isDefault0 ? undefined : p2, ),
        'shareContent_$external_fun' : (p0) => shareContent(p0)
    }
